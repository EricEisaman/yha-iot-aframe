window.AFRAME.registerComponent('door', {
      ...
      addVoiceHandlers: function(){
        let openString = `command:${this.data.openCommand};targetComponent:door;type:function;function:open`;
        let closeString = `command:${this.data.closeCommand};targetComponent:door;type:function;function:close`;
